...
from vat_sense import VatSense, AsyncVatSense, DefaultAioHttpClient
from vat_sense._utils import is_dict
...
logging.getLogger("vat_sense").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[VatSense]:
...
@pytest.fixture(scope="session")
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncVatSense]:

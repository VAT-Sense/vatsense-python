...
modify the contents of the `src/vat_sense/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/VAT-Sense/vatsense-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/VAT-Sense/vatsense-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
